          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Теперь к нам приезжают русские из всего Нью-Йорка!"
              </p>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                "3GIS помог найти постоянных клиентов. Отзывы на русском 
                очень важны - люди доверяют мнению соотечественников."
              </p>
              <div className="text-sm text-gray-500">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                "Благодаря 3GIS ко мне обращаются клиенты со всей Флориды. 
                Премиум план окупился уже через 2 недели."
              </p>
              <div className="text-sm text-gray-500">
